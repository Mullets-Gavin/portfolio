			...
			<div class="skills-container">
				<div class="skills-content">
					<div class="skills-column">
						...
						<p class="skills-body">
							I enjoy solving complex puzzles which can accomplish
							a goal to create a quality product.
						</p>
					...
					<div class="skills-column">
						...
						<p class="skills-body">
							Designing games for all ages to create memorable
							experiences people will cherish throughout their
							life.
						</p>
					...
					<div class="skills-column">
						...
						<p class="skills-body">
							A high understanding & proficiency of how commonly
							used software technologies is used.
						</p>
